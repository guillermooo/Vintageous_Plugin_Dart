...
copy-item (join-path $distDir "Vintageous_Plugin_Dart.sublime-package") $targetDir -force

if ($Release -and (!$DontUpload)) {
	start-process "https://bitbucket.org/guillermooo/vintageous_plugin_dart/downloads"
